...
# This script converts the shared AZTEC documentation into the Markdown format
...
#
# Erik Pronk (adapted from Caleb Braun)
# 4/12/2022
echo "========================="
echo "* Documentation Updater *"
echo "========================="
echo "Running this script will update AZTEC's documentation. Before running, confirm that "
...
DOC_SHARED="AZTEC Model Documentation.docx"  # the file name of the shared version
