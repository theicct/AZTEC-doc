...
| Variable Name      | Units      | Columns                                                                | Description                                                                                                                                                                                                                                                        |
|--------------------|------------|------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `emission_factors` | g/km       | Vehicle, Technology, Control, \[years\]                                | Air pollutant emission factors                                                                                                                                                                                     |
...
- **Contents:** The expected stock of infrastructure units at the start of the model
...
- **Contents:** The expected purchase schedule of infrastructure units
- **Please Exclude:** infrastructure purchased prior to the study period (should be listed instead in infrastructure base year stock)
...
| `fleet`               | Run the [Fleet Turnover](#fleet-turnover) module? `True` or `False`.                                                                                                                      |
| `emissions`           | Run the [Emissions](#emissions) module? `True` or `False`.                                                                                                                                |
