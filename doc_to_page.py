"""
Convert the AZTEC documentation from raw Word conversion to Jekyll page format.
...
def add_front_matter(lines, version):
    ...
    lines.insert(2, f"title: 'AZTEC {version} Documentation'\n")
...
def add_download_button(doc, version):
    ...
    btn = (
        f"<button name='download' onclick=\"location.href='../AZTEC {version} Model "
